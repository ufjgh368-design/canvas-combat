...
目前共 13 項自動測試，涵蓋 AI、獨立戰鬥狀態、三戰兩勝、題庫、存檔與 18 張角色圖。
...
- `data/artists.js`：18 位藝術家、招式、流派與圖鑑資料。
- `data/questions.js`：180 題三級題庫及驗證器。
...
- 每位藝術家已有一致的全身圖，但攻擊、受傷、KO 並非各自獨立點陣影格，而是由 Canvas 位移、翻轉、殘影與特效演出。
